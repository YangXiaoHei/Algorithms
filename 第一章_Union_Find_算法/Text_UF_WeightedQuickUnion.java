...
public class Text_UF_WeightedQuickUnion extends Text_UF {
	private int[] sz;
	public Text_UF_WeightedQuickUnion(int N) { super(N); 
		sz = new int[N]; 
		for (int i = 0; i < N; i++)
			sz[i] = 1;
	}
	...
	public static void main(String[] args) {
		...
		Text_UF.test(new Text_UF_WeightedQuickUnion(N), N, pairCount);
	}
	// output
	/*
	 * 	--------------------------------
